...
void aiub()
{
	...
	glBegin(GL_POLYGON);  //aiub globe window
...
void Railline()
{
    glBegin(GL_POLYGON);  //start railine1
    ...
    glBegin(GL_POLYGON);  //start railine2
	glColor3f(0.502, 0.000, 0.000);
	glVertex2i(-300, -60);
	glVertex2i(-300, -65);
	glVertex2i(300,-65);
...
void wheel1()
{
   ...
   glRotatef(_angle3,0.0, 0.0, 1.0);
	glTranslatef(-180.8,-60.0, 0.0);//Rotate about the the vector (1, 2, 3)
...
void wheel2()
{
   ...
   glRotatef(_angle4,0.0, 0.0, 1.0);
	glTranslatef(30.0,0.0, 0.0);//Rotate about the the vector (1, 2, 3)
	glColor3f(0.0,0.0,0.0);
...
void wheel3()
{
   ...
   glRotatef(_angle4,0.0, 0.0, 1.0);
	glTranslatef(-80.8,0.0, 0.0);//Rotate about the the vector (1, 2, 3)
	glColor3f(0.0,0.0,0.0);
	glBegin(GL_POLYGON);
	for(int i=0;i<200;i++)
	{
...
void wheel4()
{
   ...
   glRotatef(_angle4,0.0, 0.0, 1.0);
	glTranslatef(-100.8,0.0, 0.0);//Rotate about the the vector (1, 2, 3)
	glColor3f(0.0,0.0,0.0);
	glBegin(GL_POLYGON);
	for(int i=0;i<200;i++)
	{
...
void wheel5()
{
   ...
   glRotatef(_angle4,0.0, 0.0, 1.0);
	glTranslatef(30.8,0.0, 0.0);//Rotate about the the vector (1, 2, 3)
	glColor3f(0.0,0.0,0.0);
	glBegin(GL_POLYGON);
	for(int i=0;i<200;i++)
	{
...
void wheel6()
{
   ...
   glRotatef(_angle4,0.0, 0.0, 1.0);
	glTranslatef(-130.8,0.0, 0.0);//Rotate about the the vector (1, 2, 3)
	glColor3f(0.0,0.0,0.0);
	glBegin(GL_POLYGON);
	for(int i=0;i<200;i++)
	{
...
void drawSceneDay() {
    ...
    sun();
    backgroundDay();
    //sndPlaySound("SunnyDay.wav",SND_ASYNC|SND_LOOP);//Play background music
...
int main(int argc, char** argv)
{
    ...
    glutTimerFunc(20, update, 0);
    //sndPlaySound("SunnyDay.wav",SND_ASYNC|SND_LOOP);//Play background music
   // sndPlaySound("TrainH.wav",SND_ASYNC|SND_LOOP);//Play background music
